...
final class Version20210310140025 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD CONSTRAINT FK_B26681E6A2A8A1F FOREIGN KEY (type) REFERENCES evenement_categorie (id)');
